...
export const getDeviceType = async (balenaSdk: BalenaSDK, is_of__device_type: NavigationResource<DeviceType>) => {
    // Get the device type id from private members
    const deviceTypeId = Object.values(is_of__device_type)[0]
